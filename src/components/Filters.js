...
const Filters = () => {
  ...
  return (
    <div className="w-full h-auto p-4 border-2 border-gray-100 rounded-lg flex flex-col gap-y-4 lg:gap-y-0 justify-center lg:flex-row items-center lg:justify-between relative">
      {/* search */}
      <Search />

      {/* right block */}
      <div className="flex flex-col gap-y-4 lg:gap-y-0 items-center justify-center lg:flex-row lg:gap-x-6">
        {/* currency */}
        <div className="flex">
          <form
        ...
        <label className="relative flex items-center justify-center">
          ...
          <img
            src={selectIcon}
            alt="select"
            className="w-[1.2rem] h-auto absolute right-[2px] top-[6px] pointer-events-none"
          />
        </label>

        {/* reset button */}
        <button
          className="w-[1.5rem] ml-4 hidden lg:flex hover:scale-105 transition-all ease-linear relative"
